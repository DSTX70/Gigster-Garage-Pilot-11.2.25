...
export const startupGaragePlans = pgTable("startup_garage_plans", {
  ...
  vendorsAndSourcing: jsonb("vendors_and_sourcing").$type<Record<string, any>>().default({}),
  websiteGoals: jsonb("website_goals").$type<Record<string, any>>().default({}),
  brandAssets: jsonb("brand_assets").$type<Record<string, any>>().default({}),
  socialHandles: jsonb("social_handles").$type<Record<string, any>>().default({}),
  postingCapacity: varchar("posting_capacity", { enum: ["LOW", "MED", "HIGH"] }).default("MED"),
